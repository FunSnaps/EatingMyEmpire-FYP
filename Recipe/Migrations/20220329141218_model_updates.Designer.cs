...
namespace EatingMyEmpire.Api.Migrations
{
    ...
    [Migration("20220329141218_model_updates")]
            ...
            modelBuilder.Entity("EatingMyEmpire.Shared.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            CourseType = 0,
                            DateAdded = new DateTime(2022, 3, 29, 14, 12, 18, 540, DateTimeKind.Utc).AddTicks(7306),
                        ...
                        new
                        {
                            id = 2,
                            CourseType = 0,
                            DateAdded = new DateTime(2022, 3, 29, 14, 12, 18, 540, DateTimeKind.Utc).AddTicks(8215),
                        ...
                        new
                        {
                            id = 3,
                            CourseType = 0,
                            DateAdded = new DateTime(2022, 3, 29, 14, 12, 18, 540, DateTimeKind.Utc).AddTicks(8232),
